...
function EFFECT:Think()
	...
	if (!IsValid(self.Weapon) || !IsValid(self.Weapon:GetOwner())) then return false end
	...
	return CurTime() <= (self.Spawntime + self.Lifetime) and (IsValid(self.Weapon:GetOwner():GetActiveWeapon()) && self.Weapon:GetOwner():GetActiveWeapon():GetClass() == "weapon_ttt_donator_combinerifle")
